...
bestwish :: Program
bestwish = [ADD 0 'H',ADD 0 'a',ADD 0 'p',ADD 0 'p',ADD 0 'y',ADD 0 ' ',ADD 0 'S',ADD 0 'u',ADD 0 'm',ADD 0 'm',ADD 0 'e',ADD 0 'r',ADD 0 ' ',ADD 0 'B',ADD 0 'r',ADD 0 'e',ADD 0 'a',ADD 0 'k',ADD 0 '!',ADD 0 ' ',ADD 0 '^',ADD 0 '_',ADD 0 '^',ADD 0 'y',PRINT,HALT]
